...
export default function ShipmentMetrics({
  ...
  return (
    <>
      ...
      {data.total_shipments !== undefined &&
        data.shipment_in_transit !== undefined &&
        data.delivered_shipment !== undefined &&
        data.canceled_shipment !== undefined && (
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-lg font-bold">{data.total_shipments}</h3>
              </div>
            </div>
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              <svg
            ...
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-lg font-bold">{data.delivered_shipment}</h3>
              </div>
            </div>
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              <svg
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-lg font-bold">{data.canceled_shipment}</h3>
              </div>
            </div>
          </div>
        )}
