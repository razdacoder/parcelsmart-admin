          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-lg font-bold">{data.total_transactions}</h3>
              </div>
            </div>
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              <svg
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-sm md:text-lg font-bold">
                  {formatNaira(data.total_revenue)}
                </h3>
              </div>
            </div>
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-lg font-bold">{data.total_users}</h3>
              </div>
            </div>
            <div className="bg-white p-4 flex items-center gap-4 text-text rounded-xl">
              <svg
              ...
              <div className="space-y-1">
                <h6 className="text-xs font-medium">Total Staffs</h6>
                <h3 className="text-lg font-bold">{data.total_staffs}</h3>
              </div>
            </div>
          </div>
        )}
